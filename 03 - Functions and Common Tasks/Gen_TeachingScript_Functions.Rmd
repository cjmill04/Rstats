...
# If you run this, you will see the basic syntax of the function that runs when you run the var() command, where the function is stored, and what it is named as ("var" in this case). Pretty cool!
